...
node --expose-gc --max-old-space-size=2048 ./node_modules/.bin/mocha --sort true --file test-helper.js --timeout 480000 --ignore 'node_modules/hpagent/**/*' --slow 480000 --recursive --extension .test.js . 2>&1 | tee tests.txt
